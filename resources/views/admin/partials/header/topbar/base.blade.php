...
<div class="kt-header__topbar">
	...
	{{-- @include('ormbackend::admin.partials.header.topbar.search') --}}
	...
	@include('ormbackend::admin.partials.header.topbar.languages')
	<!--[html-partial:include:{"file":"partials/_header/topbar/_user.html"}]/-->
	@include('ormbackend::admin.partials.header.topbar.user')
</div>
