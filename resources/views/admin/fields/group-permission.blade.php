<div class="form-group row">
	...
	<div class="col-8">
		<input type="checkbox" name="permissions{{$group}}[]" value="{{ config('itaces.perms.entity.create') }}"
		...
		<input type="checkbox" name="permissions{{$group}}[]" value="{{ config('itaces.perms.entity.read') }}"
		...
		<input type="checkbox" name="permissions{{$group}}[]" value="{{ config('itaces.perms.entity.update') }}"
		...
		<input type="checkbox" name="permissions{{$group}}[]" value="{{ config('itaces.perms.entity.delete') }}"
		...
		<input type="checkbox" name="permissions{{$group}}[]" value="{{ config('itaces.perms.entity.restore') }}"
...
<div class="form-group row">
	...
	<div class="col-8">
		<input type="checkbox" name="permissions{{$group}}[]" value="{{ config('itaces.perms.record.read') }}"
			@if ($value & config('itaces.perms.record.read')) checked @endif
			data-switch="true" data-on-text="read" data-handle-width="70" data-off-text="read" data-on-color="brand">
		<input type="checkbox" name="permissions{{$group}}[]" value="{{ config('itaces.perms.record.update') }}"
			@if ($value & config('itaces.perms.record.update')) checked @endif
			data-switch="true" data-on-text="update" data-handle-width="70" data-off-text="update" data-on-color="brand">
		<input type="checkbox" name="permissions{{$group}}[]" value="{{ config('itaces.perms.record.delete') }}"
			@if ($value & config('itaces.perms.record.delete')) checked @endif
			data-switch="true" data-on-text="delete" data-handle-width="70" data-off-text="delete" data-on-color="brand">
		<input type="checkbox" name="permissions{{$group}}[]" value="{{ config('itaces.perms.record.restore') }}"
